...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { ingredient: @drink.ingredient, method: @drink.method, rname: @drink.rname } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { ingredient: @drink.ingredient, method: @drink.method, rname: @drink.rname } }
